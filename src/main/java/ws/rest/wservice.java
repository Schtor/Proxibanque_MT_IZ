...
/**
 * Interface wservice est composée des méthodes pour le webservice, on peut
 * afficher, creer, supprimer, et modifier un client. Les modifications se font
 * par attribut. On peut également afficher tous les clients en base de donnée
 * d'un coup dans une liste.
 * 
 * @author Marwa & Ihab
 *
 */
...
public interface wservice {
	...
	/**
	 * Méthode appelant l'affichage de tous les clients dans une liste à partir de
	 * la base de données.
	 * 
	 * @param Client client
	 */
	...
	/**
	 * Méthode appelant la création d'un client dans la base de données à partir du
	 * webservice.
	 * 
	 * @param Client client
	 */
	...
	/**
	 * Méthode appelant la modification du nom d'un client dans la base de données à
	...
	/**
	 * Méthode appelant la modification du telephone d'un client dans la base de
	 * données à partir du webservice.
	 * 
