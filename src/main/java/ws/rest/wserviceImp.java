...
public class wserviceImp implements wservice {
	...
	/**
	 * Méthode permettant d'instancier une base de données fournie au démarrage du
	 * serveur.
	 * 
	 * 
	 */
	 ...
	 * Les données entrées en xml ou en json dans le webservice sont prises en
	 * compte dans le constructeur pour que l'objet client créé en base ait les
	 * attributs spécifiés.
	 * 
	 * @param Client c
	 */
	...
	/**
	 * Méthode permettant d'afficher la liste de tous les clientq en xml ou en json
	 * dans le webservice à partir de la base de données.
	 * 
	 * @param Long id
	 */
	@Override
	...
	/**
	 * Méthode permettant de supprimer un client dans la base de donénes à partir du
	 * webservice.
	 * 
	 * @param Long id
	 */
	...
	/**
	 * Méthode permettant de modifier le nom d'un client en base de données, à
	 * l'aide d'entrées en xml ou en json dans le webservice.
	 *
	...
	/**
	 * Méthode permettant de modifier le telephone d'un client en base de données, à
	 * l'aide d'entrées en xml ou en json dans le webservice.
	 *
	...
	/**
	 * Méthode permettant de modifier la ville d'un client en base de données, à
	 * l'aide d'entrées en xml ou en json dans le webservice.
	 *
	...
	/**
	 * Méthode permettant de modifier le code postal d'un client en base de données,
	 * à l'aide d'entrées en xml ou en json dans le webservice.
	 *
	...
	/**
	 * Méthode permettant de modifier l'adresse d'un client en base de données, à
	 * l'aide d'entrées en xml ou en json dans le webservice.
	 *
